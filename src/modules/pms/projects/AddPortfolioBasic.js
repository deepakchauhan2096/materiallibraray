...
import ThumbNailUpload from './ProjectImageUploader';
                        ...
                        <div className='row'>
                            ...
                            <div className='col  addproject_form_area padding-left-right-zero'>
                                ...
                                <div class="form-group addproject-label-name-margin-top">
                                    ...
                                    <textarea class="form-control form-control brief-discription-portfolio-field-height" placeholder="#Flat No, Block, Street, Area" rows="25"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
